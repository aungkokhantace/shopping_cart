                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group float-right" role="group">
                                                            <a href="/view_transactions/detail/{{$transaction->id}}"><button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="View Detail">View Detail</button></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php $counter++; ?>
